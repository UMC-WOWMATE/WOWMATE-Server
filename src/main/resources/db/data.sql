...
--
-- insert into Post (post_id, user_id, title, context, like_number, category_name, tag1, tag2, tag3, tag4, tag5, member) values (1, 1, "게시글1-1", "게시글 내용", 0, "카테고리1", "태그1", "태그2", "태그3", "태그4", "태그5",0);
--
--
